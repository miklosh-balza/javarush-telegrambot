...
JavaRush Telegram bot for training

# Idea
The main idea is to learn new technologies on practice, and create real application which can be used by someone else. 
# MVP Scope
As a user, I want to subscribe to group of posts and get notifications via telegram-bot every time, when new post related to a group of subscriptions has come.
# How it works 
